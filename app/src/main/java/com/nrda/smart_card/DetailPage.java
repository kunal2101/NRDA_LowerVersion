...
public class DetailPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aQuery = new AQuery(DetailPage.this);
    ...
    private void otp_info() {
        ...
        ProgressDialog progressDialog = new ProgressDialog(DetailPage.this);
    ...
    protected boolean isConnection() {
        ConnectivityManager manage = (ConnectivityManager) DetailPage.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo info = manage.getActiveNetworkInfo();
        if (info != null && info.isConnectedOrConnecting()) {

            return true;
        } else {
            Toast.makeText(DetailPage.this, getResources().getString(R.string.check_internet), Toast.LENGTH_LONG).show();
            return false;
        }
    }
