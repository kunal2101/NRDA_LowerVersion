...
public class Market_tour_strat  extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_market_tour_strat);
        ...
        card_view_one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent inty = new Intent(Market_tour_strat.this, Market_Tour_detail.class);
                startActivity(inty);
                //finish();
