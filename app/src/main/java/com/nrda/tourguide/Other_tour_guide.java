...
public class Other_tour_guide extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_tour_guide);
        ...
        map_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(Other_tour_guide.this, TourGuideNearestStop.class);
                in.putExtra("KEY_LAT", "21.204554");
                in.putExtra("KEY_LNG", "81.819462");
                startActivity(in);
            }
        });
        tool_back_icon.setVisibility(View.VISIBLE);
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
        mapFragment.getMapAsync(Other_tour_guide.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder().target(
                new LatLng(21.204554,81.819462)).zoom(12).build();
