...
public class MusicalFountain extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_musical_fountain);
        ...
        mapFragment.getMapAsync(MusicalFountain.this);

        map_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(MusicalFountain.this, TourGuideNearestStop.class);
                in.putExtra("KEY_LAT", "21.162563");
                in.putExtra("KEY_LNG", "81.782634");
                startActivity(in);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder().target(
                new LatLng(21.162563,81.782634)).zoom(12).build();
