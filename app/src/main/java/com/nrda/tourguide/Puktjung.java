...
public class Puktjung extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puktjung);
        ...
        mapFragment.getMapAsync(Puktjung.this);
        map_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(Puktjung.this, TourGuideNearestStop.class);
                in.putExtra("KEY_LAT", "21.132309");
                in.putExtra("KEY_LNG", "81.757379");
                startActivity(in);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder().target(
                new LatLng(21.132309,81.757379)).zoom(12).build();
