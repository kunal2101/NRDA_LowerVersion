...
public class Tour_Immersive_Dome extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tour__immersive__dome);
        ...
        mapFragment.getMapAsync(Tour_Immersive_Dome.this);
        map_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(Tour_Immersive_Dome.this, TourGuideNearestStop.class);
                in.putExtra("KEY_LAT", "21.166970");
                in.putExtra("KEY_LNG", "81.787532");
                startActivity(in);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        CameraPosition cameraPosition = new CameraPosition.Builder().target(
                new LatLng(21.166970,81.787532)).zoom(12).build();
